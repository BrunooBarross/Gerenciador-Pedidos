 ...
 * @author GuiManu
 */
public class ListaVendaController implements Initializable {
    ...
    @FXML
    private TableColumn<venda, String> clmidproduto;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btalterar.setOnMouseClicked((MouseEvent e)->{
            ...
            try {
                ...
                Logger.getLogger(ListaVendaController.class.getName()).log(Level.SEVERE, null, ex);
            }
            }else{
            Alert a = new Alert(Alert.AlertType.CONFIRMATION);
            a.setHeaderText("Venda Não Selecionado");
            a.show();
            }
        });
    }    
